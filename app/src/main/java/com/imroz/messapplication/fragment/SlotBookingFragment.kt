...
class SlotBookingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_slot_booking, container, false)
        ...
        btnBook= view.findViewById(R.id.btnConfirm)
        btnBook.setOnClickListener {
            btnBook.visibility= View.INVISIBLE
            Toast.makeText(activity, "Your response is stored..You can only book once..", Toast.LENGTH_LONG).show()
        }
